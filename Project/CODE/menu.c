...
//        oled_int16(0,1,icm_acc_z);
//        oled_int16(0,2,icm_acc_x);
//        oled_int16(0,2,icm_gyro_y);
//        oled_int16(0,4,angle_acc);
//        oled_int16(0,5,angle_gyro);
        oled_int16(0,1,angle_final);
        oled_int16(0,2,upright.Kp);
        oled_int16(0,3,upright.Kd);
        oled_int16(0,4,upright.value);
        oled_int16(0,6,leftpwm);
        oled_int16(0,7,rightpwm);

        oled_int16(46,1,L_C+R_C);
        oled_int16(46,2,speed_set);
        oled_int16(46,4,speed_cl.Kp);
        oled_int16(46,5,speed_cl.Ki);
        oled_int16(46,6,speed_cl.Kd);
        oled_int16(46,7,speed_cl.value);

        oled_int16(90,1,beacon_x);
        oled_int16(90,2,beacon_y);
        oled_int16(90,3,beacon_list[beacon_y]);
        oled_int16(90,5,direction.Kp);
        oled_int16(90,6,direction.Kd);
        oled_int16(90,7,direction.value);
//        oled_int16(90,4,beacon_flag);
//        oled_int16(90,5,Down_Point_flag);
    }
    else
    {
        if(menu_button_flag == 1)
...
void Menu_Init(void)
{
    ...
    Menu_Item_Init(&PID_menu[18],&PID_menu[17],&PID_menu[19],"Help_Kp",   &upr_help.Kp);
    Menu_Item_Init(&PID_menu[19],&PID_menu[18],&PID_menu[20],"Help_Ki",   &upr_help.Ki);
    Menu_Item_Init(&PID_menu[20],&PID_menu[19],&PID_menu[21],"Help_Kd",   &upr_help.Kd);
