...
//----宏定义OLED引脚----
#define OLED_SCL_PIN			C9
#define OLED_SDA_PIN			C8
#define OLED_RST_PIN			C7
...
void oled_dis_bmpr(uint16 high, uint16 width, uint8 *p);
//void Draw_Row(uint8 row_number);
//void Draw_Column(uint8 colume_number);
//void Draw_Beacon(uint8 x,uint8 y);
